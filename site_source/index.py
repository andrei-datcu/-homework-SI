...
print '<input type="text" class="form-control" name="startd" id="dp" value="%s"> - ' % dic.get("startd", "2014-12-19")
print '<input type="text" class="form-control" id="dp2" name="endd" value="%s">' % dic.get("endd", "2015-01-06")
print '</div></div></div>'
